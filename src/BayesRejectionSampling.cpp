...
class CRejectionSampling : public CRejectionSamplingCapable<CPose2D>
{
protected:
...
void TestRS()
{
    CRejectionSampling RS;
    std::vector<CRejectionSampling::TParticle> samples;
    CTicTac tictac;
    ...
    std::vector<CRejectionSampling::TParticle>::iterator it;
